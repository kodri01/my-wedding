...
1. **Unduh proyek atau kloning repositori**:
    ```bash
    git clone https://github.com/kodri01/my-wedding.git
    ```

2. **Catatan**: Anda memiliki dua pilihan untuk menggunakan kode sumber ini:
    - **Tanpa Modifikasi**: Buka file [data.js](https://github.com/kodri01/my-wedding/blob/main/src/assets/data/data.js) untuk langsung menggunakannya.
